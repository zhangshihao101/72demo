...
public class CameraInterface {
    ...
    private void initCamera(float previewRate) {
        if (mCamera != null) {
            ...
            Size pictureSize =
                    CamParaUtil.getInstance().getPropPictureSize(mParams.getSupportedPictureSizes(), previewRate, 800);
            mParams.setPictureSize(pictureSize.width, pictureSize.height);
            Size previewSize =
                    CamParaUtil.getInstance().getPropPreviewSize(mParams.getSupportedPreviewSizes(), previewRate, 800);
     ...
     * 常规拍照
     */
    PictureCallback mJpegPictureCallback = new PictureCallback() {// 对jpeg图像数据的回调,最重要的一个回调
    ...
    PictureCallback mRectJpegPictureCallback = new PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            if (null != b) {
                ...
                Log.i(TAG, "rotaBitmap.getWidth() = " + rotaBitmap.getWidth() + " rotaBitmap.getHeight() = "
                        + rotaBitmap.getHeight());
                rectBitmap = Bitmap.createBitmap(rotaBitmap, x, y, DST_RECT_WIDTH, DST_RECT_HEIGHT);
