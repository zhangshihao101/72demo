...
public class MtsStkLowFragment extends BaseMtsFragment {
	private View view;
	...
	private String facilityId = "", productName = "", brandName = "", unicode = "", modelId = "";
		...
		OkHttpManager.client
				.newCall(new Request.Builder().url(MtsUrls.base + MtsUrls.getInventoryBySearchParams)
						.post(new FormBody.Builder()
								...
								.add("orderBy", "totalAvailableQuantity").add("viewIndex", page + "").build())
						.build())
		...
		OkHttpManager.client
				.newCall(
						new Request.Builder()
								...
								.post(new FormBody.Builder()
										.add("externalLoginKey", Localxml.search(mContext, "externalloginkey"))
										.add("orderBy", "totalAvailableQuantity").add("facilityId", facilityId)
