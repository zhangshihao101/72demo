...
public class MtsManufacturersBarcodeFragment extends Fragment {
    ...
    private void initData() {
        try {
            ...
            for (int i = 0; i < arrayDetail.length(); i++) {
                ...
                info.setProBarcode(objDetail.optString("manuValue"));
    ...
    public String getVariants() {
        ...
        try {
            for (int i = 0; i < mData.size(); i++) {
                ...
                varObjact.put("manuValue", mData.get(i).getProBarcode());
                varArray.put(varObjact);
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
        Log.e("===========" + varArray.toString());
    ...
    public void updateManuBarcode() {
        ...
        OkHttpManager.client
                .newCall(new Request.Builder().url(MtsUrls.base + MtsUrls.update_manuvalue)
